 ...
 * @param {number} depth - the depth of the recursive tree of all possible moves
 * @param {number} alpha  - alpha value for alpha-beta pruning
 * @param {number} beta  - beta value for alpha-beta pruning
 * @param {boolean} isMaximizingPlayer - true if the current layer is maximizing, false otherwise
 * @param {number} sum - the sum (evaluation) so far at the current layer
 * @param {string} color  - the color of the current player
 * @returns {array} - the best move at the root of the current subtree
 */
